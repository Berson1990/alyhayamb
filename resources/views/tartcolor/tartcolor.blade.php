...
@section('content')
    <div id="TartColor">
        <div class="row">
            ...
            <br>
            <data-tables :data="TartColorData" :show-action-bar="false" :custom-filters="customFilters"
                ...
                <el-table-column label="صور الاضافة">
                    <template slot-scope="scope">
                        <img width="50" height="50" :src="'tartColors/' + scope.row.tart_colorImage" class="img-responsive">
                    </template>
                </el-table-column>
                        ...
                        <div class="modal-body">
                            <form :model="form">
                                ...
                                <div class="form-group">
                                    <label for="item_name">اسم  اللون</label>
                                    <input v-model="form.color_name" type="text" class="form-control"
                                           id="item_name"
                                           placeholder="اسم اللون " name="email">
                                </div>
                                <div class="form-group">
                                    <label for="item_nameen">اسم وصف اللون </label>

                                    <input v-model="form.color_discribtion" type="text" class="form-control"
                                           id="item_nameen"
                                           placeholder="وصف اللون   " name="pwd">
                                </div>
...
@section('page-script-level')
    <script src={{asset("AdminScript/tart_color.js")}}></script>
@endsection